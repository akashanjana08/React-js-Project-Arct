...
function get(url, header, body) {
    return axios.get(url, { headers: {'content-type': 'application/json'} }).then(handleResponse).catch(error);
}
...
function put(url, header, body) {
    return axios.put(url, body, { headers: {'content-type': 'application/json'} }).then(handleResponse).catch(error);
}
...
function post(url, header, body) {
    return axios.post(url, body, { headers: {'content-type': 'application/json'} }).then(handleResponse).catch(error);
}
...
function _delete(url, header, params) {
    return axios.delete(url, { headers: {'content-type': 'application/json'} }).then(handleResponse).catch(error);
}
